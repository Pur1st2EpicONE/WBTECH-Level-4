...
func TestCreateEvent_Success(t *testing.T) {
	...
	mockArchive := storageMock.NewMockArchive(controller)
	mockMemory := storageMock.NewMockMemory(controller)
	storage := &repository.Storage{Archive: mockArchive, Memory: mockMemory}

	service := NewService(config.Service{MaxEventsPerUser: 5}, storage, mockLogger)
	...
	mockMemory.EXPECT().CountUserEvents(event.Meta.UserID).Return(0, nil)
	mockMemory.EXPECT().CreateEvent(event).Return("result id", nil)
...
func TestCreateEvent_ErrCountUserEvents(t *testing.T) {
	...
	mockMemory.EXPECT().CountUserEvents(event.Meta.UserID).Return(0, assert.AnError)
...
func TestCreateEvent_ErrMaxEvents(t *testing.T) {
	...
	mockMemory.EXPECT().CountUserEvents(event.Meta.UserID).Return(5, nil)
...
func TestUpdateEvent_Success(t *testing.T) {
	...
	mockMemory.EXPECT().GetEventByID(eventID).Return(oldEvent)
	mockMemory.EXPECT().UpdateEvent(event).Return(nil)
...
func TestUpdateEvent_ErrEventNotFound(t *testing.T) {
	...
	mockMemory.EXPECT().GetEventByID(eventID).Return((*models.Event)(nil))
...
func TestDeleteEvent_Success(t *testing.T) {
	...
	mockMemory.EXPECT().GetEventByID(meta.EventID).Return(oldEvent)
	mockMemory.EXPECT().DeleteEvent(meta).Return(nil)
...
func TestDeleteEvent_ErrEventNotFound(t *testing.T) {
	...
	mockMemory.EXPECT().GetEventByID(meta.EventID).Return((*models.Event)(nil))
...
func TestGetEvents_SuccessSorted(t *testing.T) {
	...
	mockMemory.EXPECT().GetEvents(meta, models.Day).Return(unsorted, nil)
...
func TestGetEvents_ErrStorage(t *testing.T) {
	...
	mockMemory.EXPECT().GetEvents(meta, models.Day).Return(nil, assert.AnError)
